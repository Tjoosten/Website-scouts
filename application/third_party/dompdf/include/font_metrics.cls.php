...
class Font_Metrics
{
   ...
   * @return float
   */
  public static function get_text_width($text, $font, $size, $word_spacing = 0, $char_spacing = 0)
  {
   ...
   * @return string
   */
  public static function get_font($family, $subtype = 'normal')
  {
   ...
   *
   * The name and location of the cache file are determined by {@link * Font_Metrics::CACHE_FILE}.  This file should be writable by the
   * webserver process.
   *
