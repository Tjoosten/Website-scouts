...
class Cellmap
{
   ...
   * @var array
   */
  protected static $_BORDER_STYLE_SCORE = ['inset'       => 1,
                                                'groove' => 2,
                                                'outset' => 3,
                                                'ridge'  => 4,
                                                'dotted' => 5,
  ...
  public function get_spanned_cells($frame)
  {
      $key = $frame->get_id();
    ...
    public function frame_exists_in_cellmap($frame)
    {
        $key = $frame->get_id();
    ...
    public function get_frame_position($frame)
    {
    ...
    public function get_frame_width($frame)
    {
        $key = $frame->get_id();
    ...
    public function get_frame_height($frame)
    {
        $key = $frame->get_id();
