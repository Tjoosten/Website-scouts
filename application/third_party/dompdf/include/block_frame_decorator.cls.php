...
class Block_Frame_Decorator extends Frame_Decorator
{
  ...
  protected static $_initial_line_state = [
    'frames'        => [],
    'wc'            => 0,
    'y'             => null,
    'w'             => 0,
  ...
  public function __construct(Frame $frame, DOMPDF $dompdf)
  {
      ...
      $this->_lines = [self::$_initial_line_state];

      $this->_counters = [self::DEFAULT_COUNTER => 0];
      $this->_cl = 0;
  }
  ...
  public function get_current_line($i = null)
  {
  ...
  // Set methods
  public function set_current_line($y = null, $w = null, $h = null, $tallest_frame = null, $left = null, $right = null)
  {
    ...
    public function set_line($lineno, $y = null, $w = null, $h = null, $tallest_frame = null, $left = null, $right = null)
    {
        if (is_array($y)) {
            extract($y);
        }
    ...
    public function add_frame_to_line(Frame $frame)
    {
        ...
        if (in_array($style->position, ['absolute', 'fixed']) ||
