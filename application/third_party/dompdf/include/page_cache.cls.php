...
class Page_Cache
{
    ...
    {
        throw new Exception('Can not create instance of Page_Class.  Class is static.');
    }
    ...
    public static function store_page($id, $page_num, $data)
    {
    ...
    public static function store_fonts($id, $fonts)
    {
        self::__query('BEGIN');
...
//   }
  ...
  public static function get_page_timestamp($id, $page_num)
  {
  ...
  public static function insert_cached_document(CPDF_Adapter $pdf, $id, $new_page = true)
  {
