...
class Table_Frame_Reflower extends Frame_Reflower
{
  ...
  protected $_state;
    ...
    public function __construct(Table_Frame_Decorator $frame)
    {
        $this->_state = null;
  ...
  protected function _assign_widths()
  {
    ...
    $left = $style->margin_left;
      ...
      $delta = $left + $right + $style->length_in_pt([$style->padding_left,
  ...
  public function reflow(Frame_Decorator $block = null)
  {
    ...
    $content_x = $x + $left + $style->length_in_pt([$style->padding_left,
                                                         $style->border_left_width, ], $cb['w']);
      $content_y = $y + $style->length_in_pt([$style->margin_top,
  ...
  public function get_min_max_width()
  {
    ...
    $dims = [$style->border_left_width,
      ...
      return $this->_min_max_cache = [$this->_state['min_width'], $this->_state['max_width'],
