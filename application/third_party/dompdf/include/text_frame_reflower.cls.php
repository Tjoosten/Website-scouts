...
class Text_Frame_Reflower extends Frame_Reflower
{
  ...
  protected $_frame;
    ...
    public function __construct(Text_Frame_Decorator $frame)
    {
...
//       $text = ltrim($text, " \n\r\t");
  ...
  protected function _line_break($text)
  {
    ...
    $text_width = Font_Metrics::get_text_width($text, $font, $size, $word_spacing, $char_spacing);
      $mbp_width =
      $style->length_in_pt([$style->margin_left,
  ...
  protected function _layout_line()
  {
    ...
    if ($text === '') {
      ...
      if ($split == 0 && $text === ' ') {
        ...
        // Layout the new line
        $this->_layout_line();
          } elseif ($split < mb_strlen($this->_frame->get_text())) {
...
//     }
  ...
  public function get_min_max_width()
  {
    ...
    case 'pre-wrap':
      ...
      $delta = $style->length_in_pt([$style->margin_left,
                                        $style->border_left_width,
                                        $style->padding_left,
                                        $style->padding_right,
                                        $style->border_right_width,
