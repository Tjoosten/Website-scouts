...
class TCPDF_Adapter implements Canvas
{
   ...
   * @var array;
   */
  public static $PAPER_SIZES = []; // Set to
  ...
  public function __construct($paper = 'letter', $orientation = 'portrait')
  {
      ...
      $this->_pdf = new TCPDF('P', 'pt', [$this->_width, $this->_height]);
   ...
   */
  public function text($x, $y, $text, $font, $size, $color = [0,0,0], $adjust = 0)
  {
      // FIXME
  }
   ...
   * @return float
   */
  public function get_text_width($text, $font, $size, $spacing = 0)
  {
      // FIXME
  }
